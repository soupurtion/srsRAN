...
{
  // Parse config files
  std::cout<<"Lets see if enb Id is there"<<std::endl;
  std::cout<<rrc_cfg_->enb_id<<std::endl;
  ...
  std::cout<<"Cell infromation checking: ";
  std::cout<<cell_common_cfg.nof_ports;
  std::cout<<" ";
  std::cout<<cell_common_cfg.frame_type;
  std::cout<<" "; 
  std::cout<<cell_common_cfg.phich_length;
  ...
  std::cout<<"From parse_cfg_files: ";
  //std::cout<<rrc_cfg_->sib1.sib_sign1<<std::endl;
  //std::cout<<rrc_cfg_->sib1.sib_sign8<<std::endl;
...
//Sourav Purification SIB infromation parsers
namespace sib_sections {

int parse_sib1(std::string filename, sib_type1_s* data) // Sourav: filename = sib.conf data=a pointer variable of sib1 i.e. rrc_cfg_->sib1
{
  parser::section sib1("sib1");
  //Here do not understand how they use the sib.conf file to get sib informations
  ...
  //sib1.add_field(make_asn1_enum_str_parser("signature", &data->sib_sign));
...
int parse_sibs(all_args_t* args_, rrc_cfg_t* rrc_cfg_, srsenb::phy_cfg_t* phy_config_common)
{
  ...
  //Sourav Here is the parsing of SIB information
  sib_type1_s* sib1 = &rrc_cfg_->sib1; // Sourav: Created this pointer sib1 variable to write directly to rrc_cfg->sib1 content
  
  // Sourav: Now it is calling this function with sib_config file and sib1 pointer to build sib1 message. sib1 is a part of rrc_cfg_ struct variable 
  ...
  //sib1->sib_sign = "Hello World";
  //std::cout<<sib1->sib_sign<<std::endl;
  // Generate SIB2
