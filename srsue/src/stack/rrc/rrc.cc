...
{
  // Stop BCCH search after successful reception of 1 BCCH block. Sourav May be here to find the SIB/MIBs
  mac->bcch_stop_rx();

  bcch_dl_sch_msg_s dlsch_msg;
  asn1::cbit_ref    dlsch_bref(pdu->msg, pdu->N_bytes);
  std::cout<<"Bytes length"<<pdu->N_bytes<<std::endl;
  asn1::SRSASN_CODE err = dlsch_msg.unpack(dlsch_bref);
  //Base station authentication: Displaying digital signature at UE in console
  std::cout<<"DLSCH: "<<dlsch_msg.msg.c1().sib_type1().cybersecurity_lab_authentication<<std::endl;
  ...
  //std::string sign = "0866C8F16F1500408AE21B4056289C178BCA649937DC35ADAD60184D63CF4A06784CB70BA3FF4FCED301275C6CED06F0D7636DC6BE0659E8C3A5CE8AF1DE01D5";
  //Base station authentication: validating digital signature
  //if (dlsch_msg.msg.c1().sib_type1().cybersecurity_lab_authentication == asn1::rrc::generate_signature()) {
    //  std::cout<<"SIB1 digital signature matched"<<std::endl;
      //logger.error(pdu->msg, pdu->N_bytes, "SIB1 digital signature does not match (%d B).", pdu->N_bytes);
  //}
...
void rrc::handle_sib1()
{
  ...
  std::cout<<"SIB Digital Signature "<<sib1->cybersecurity_lab_authentication<<std::endl;
  ...
  //std::cout<<sib1->sib_sign[5]<<std::endl;
  // Set TDD Config
