...
#include <iostream> // Cybersecurity lab: Access to cout
...
SRSASN_CODE sib_type1_s::pack(bit_ref& bref) const
{
  ...
  // //Base station authentication: Pack the data field
  //cell_access_related_info.cybersecurity_lab_authentication = "This is 256 Byte Information";
  uint32_t auth_n_bytes = static_cast<uint32_t>(cybersecurity_lab_authentication.length());
  std::cout<<"Number of Bytes packing:"<<auth_n_bytes<<std::endl;
  std::vector<uint8_t> auth_val(cybersecurity_lab_authentication.begin(), cybersecurity_lab_authentication.end());
...
{ 
  std::cout<<"Now in unpacking function"<<std::endl;
  ...
  // //Base station authentication: Unpack the data field
  uint32_t auth_n_bytes = static_cast<uint32_t>(cybersecurity_lab_authentication.length());
  std::cout<<"Byte length Unpacking:"<<auth_n_bytes<<std::endl;
  std::vector<uint8_t> auth_val(cybersecurity_lab_authentication.length());
  uint8_t *auth_val_pointer = &auth_val[0];
  HANDLE_CODE(bref.unpack_bytes(auth_val_pointer, auth_n_bytes));
  std::string temp_str(auth_val.begin(), auth_val.end());
  cybersecurity_lab_authentication = temp_str;
  std::cout << "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!Digital Signature from unpacking function!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!" << std::endl;
  std::cout << cybersecurity_lab_authentication << std::endl;
  std::cout << "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!" << std::endl;
...
void sib_type1_s::to_json(json_writer& j) const
{
  ...
  // //Base station authentication: loging digital signature to json file
  j.write_str("cybersecurity_lab_authentication", cybersecurity_lab_authentication);
...
std:: string asn1::rrc::generate_signature()
{
 return "5D66C8F16F1500408AE21B4056289C178BCA649937DC35ADAD60184D63CF4A06784CB70BA3FF4FCED301275C6CED06F0D7636DC6BE0659E8C3A5CE8AF1DE0180";
}
